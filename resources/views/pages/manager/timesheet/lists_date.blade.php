...
@section('body')
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation"><a href="{{ action('TimesheetController@managersUsers') }}">{{ trans('messages.by-user') }}</a></li>
        <li role="presentation" class="active"><a href="{{ action('TimesheetController@managersDays') }}">{{ trans('messages.by-day') }}</a></li>
    </ul>
