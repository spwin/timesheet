    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li {{ (Request::is('*admin/timesheet*') ? 'class=active' : '') }}><a href="{{ action('TimesheetController@admin') }}">{{ trans('messages.payroll') }}</a></li>
                <li {{ (Request::is('*managers*') ? 'class=active' : '') }}><a href="{{ action('ManagerController@index') }}">{{ trans('messages.managers') }}</a></li>
                <li {{ (Request::is('*users*') ? 'class=active' : '') }}><a href="{{ action('UsersController@index') }}">{{ trans('messages.users') }}</a></li>
                <li {{ (Request::is('*settings*') ? 'class=active' : '') }}><a href="{{ action('SettingsController@index') }}">{{ trans('messages.settings') }}</a></li>
            </ul>
