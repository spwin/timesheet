...
@section('body')
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation"><a href="{{ action('TimesheetController@requestsUsers') }}">By user</a></li>
        <li role="presentation" class="active"><a href="{{ action('TimesheetController@requestsDays') }}">By day</a></li>
    </ul>
